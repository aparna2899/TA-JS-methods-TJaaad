...
for(let character of quote.slice(0,6)){
  console.log(`The character at index 0 is '${character}'`);
}
...
quoteSplitted.splice(quoteSplitted.indexOf('today'),quoteSplitted.indexOf('today'),'tomorrow');
console.log(quoteSplitted);
...
let startPad = (quote.padStart(70, '.'));
